                ...
                <div className="shrink-0 flex flex-col items-center md:items-start relative z-20 mt-2 md:mt-0 mb-6 md:mb-0">
                    ...
                    >
                        ...
                        <div className="relative inline-flex overflow-hidden rounded-full p-[1px]">
                            ...
                            <a href="mailto:moazshaker121@gmail.com" className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-white/90 px-6 py-2.5 text-sm font-bold text-gray-800 backdrop-blur-3xl hover:bg-white transition-all gap-2">
