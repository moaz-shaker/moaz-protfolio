...
import { Mail, Home, Zap, User, Briefcase, Menu, X, MessageCircle, Phone } from 'lucide-react';
...
const socialLinks = [
    { icon: LinkedInIcon, href: "https://www.linkedin.com/in/moazshaker/", label: "LinkedIn" },
    { icon: GithubIcon, href: "https://github.com/moaz-shaker", label: "Github" },
    { icon: Mail, href: "mailto:moazshaker121@gmail.com", label: "Email" },
    { icon: MessageCircle, href: "https://wa.me/966575809340", label: "WhatsApp" },
    { icon: Phone, href: "tel:+966575809340", label: "Phone" },
] as const;
                ...
                <div className="flex items-center gap-2 md:gap-4 pointer-events-auto">
                    <div className="flex items-center p-1.5 pl-3 md:pl-4 gap-3 bg-white/40 backdrop-blur-[32px] border border-white/40 shadow-[0_24px_48px_-12px_rgba(0,0,0,0.08),inset_0_1px_1px_rgba(255,255,255,0.8)] rounded-full transition-all duration-500 hover:bg-white/50 transform-gpu ring-1 ring-black/[0.03]">
                        ...
                        >
                            ...
                            <span className="font-designer text-xl md:text-2xl tracking-tighter text-gray-900 hidden sm:block opacity-90 group-hover:opacity-100 transition-opacity">Moaz</span>
                        </div>
